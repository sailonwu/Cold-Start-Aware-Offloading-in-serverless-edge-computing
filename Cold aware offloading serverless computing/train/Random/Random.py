...
def train(iot_RL_list, NUM_EPISODE):
    ...
    for episode in range(NUM_EPISODE):
        ...
        np.savetxt(f'./结果分析/奖励-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', reward_list_record, delimiter=',')
        np.savetxt(f'./结果分析/丢失任务总数-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record, delimiter=',')
        np.savetxt(f'./结果分析/任务总时延-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', delay_list_record, delimiter=',')
        np.savetxt(f'./结果分析/任务总能耗-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', energy_list_record, delimiter=',')
        np.savetxt(f'./结果分析/任务总花费-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', expense_list_record, delimiter=',')
        np.savetxt(f'./结果分析/任务是冷启动-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', cold_count_list_record, delimiter=',')
        np.savetxt(f'./结果分析/任务是热启动-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', warm_count_list_record, delimiter=',')
        np.savetxt(f'./结果分析/成功任务总数-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', sucess_count_list_record, delimiter=',')
        np.savetxt(f'./结果分析/卸载结果iot_-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', action_record_iot, delimiter=',')
        np.savetxt(f'./结果分析/卸载结果edge_-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', action_record_edge, delimiter=',')
        np.savetxt(f'./结果分析/卸载结果cloud_-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', action_record_cloud, delimiter=',')
        np.savetxt(f'./结果分析/任务执行标志0-总数-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record0, delimiter=',')
        np.savetxt(f'./结果分析/任务执行标志1--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record1, delimiter=',')
        np.savetxt(f'./结果分析/任务执行标志2--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record2, delimiter=',')
        np.savetxt(f'./结果分析/任务执行标志3--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record3, delimiter=',')
        np.savetxt(f'./结果分析/任务执行标志4--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record4, delimiter=',')
        np.savetxt(f'./结果分析/任务执行标志5--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', unfinish_total_list_record5, delimiter=',')
        np.savetxt(f'./结果分析/网络选择动作数量--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', choose_action_by_net, delimiter=',')
        np.savetxt(f'./结果分析/随机选择动作数量--Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.csv', choose_action_by_random, delimiter=',')
        '''if episode == 10:
            return'''
...
if __name__ == "__main__":
    ...
    with open('任务数txt/record-Random_4_arrive_0001_learning_99_discount_64_batchsize_max_delay_2_iot.txt', 'w') as f:
